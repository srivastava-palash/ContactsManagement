...
String finalString = "";
System.out.println("**********************************************************************************");
System.out.println("\n\t\t\tCONTACTS DEVELOPMENT DATABASE PROJECT");
System.out.println("\t\t\t\t\t SAXOBEAT");
System.out.println("**********************************************************************************");
while(ch != 4)
{
		...
		ch = sc.nextInt();              // Input taken by the scanner file
                ...
                switch(ch)
		{
			...
			case 2: contactBookName = "";
					...
					System.out.println("\nENTER NAME OF CONTACTS BOOK WITHOUT EXTENSION TO LOAD FROM THE DATABASE YOU HAVE CREATED");
					contactBookName = stringReader.nextLine();
					...
					while(true)
					{
						if(contactBookName.equals(""))
						{
							System.out.println("\nCONTACT BOOK NAME CANNOT BE EMPTY. PLEASE ENTER A VALID FILE NAME");
					...
					if(!contactBook.exists())
					{
						System.out.println("\nA CONTACT BOOK WITH NAME "+contactBookName+" DOES NOT EXIST IN OUR DATABASE");
					}
					else
					{
						contactBookOperations(contactBookName);
			...
			case 3: contactBookName = "";
					...
					System.out.println("\nENTER NAME OF CONTACTS BOOK WITHOUT EXTENSION TO DELETE FROM THE DATABASE");
					contactBookName = stringReader.nextLine();
					
					
						if(contactBookName.equals(""))
						{
							System.out.println("\nCONTACT BOOK NAME CANNOT BE EMPTY ANYTIME ");
					...
					if(!contactBook.exists())
					{
						System.out.println("\nA CONTACT BOOK WITH NAME "+contactBookName+" DOES NOT EXIST IN YOUR DATABASE");
					}
					else
					{
						contactBook.delete();
			...
			case 4: System.out.println("\nOK BYE\nThis project was developed by----------\n Palash Srivastava and Harmanpreet singh and Apurva Jain  \n +919758780806 \t\t +918878238088 \n Under the guidance of our teacher in NIIT,\n Bittan Market ,\n Arera Coloney, Bhopal");
					break;
 ...
 
 {
	...
	case 1:                                              // add contact option.............
			...
			while(invalidTag)
			{
				...
				switch(tag)
				{
					...
					case 4:
							...
							break;
					default:
							System.out.println("\nENTER ONLY NUMBERS IN THE RANGE 1-4. SO NOT EXCEPTED");
							invalidTag = true;
							break;
				}
			}
			...
			while(morePhone)
			{
				...
				{
					System.out.println("\n Please enter a valid phone number. for ex- +911234567899");
					sc.next();
				}
	...
	case 2: String editName = "";
				...
				while( ((line=fileReader.readLine())!=null))	 // read till end of file
			{
				...
				invalidTag = true;
				String editContact = "";
				System.out.println("\nENTER THE CONTACT TO BE EDITED(SHOULD BE FROM THE DATABASE)");
				editName = stringReader.nextLine();
				if(!nameList.contains(editName))
				{
					System.out.println("\nA CONTACT WITH NAME "+editName+" DOES NOT EXIST IN EXISTING DATABASE");
				}
